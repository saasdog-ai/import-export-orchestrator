...
class AzureBlobStorage:
    ...
    def __init__(self, container_name: str, account_name: Optional[str] = None):
        ...
        try:
            ...
            with open(local_file_path, "rb") as data:
                await loop.run_in_executor(
                    None, lambda: blob_client.upload_blob(data, overwrite=True, content_settings=content_settings)
                )
