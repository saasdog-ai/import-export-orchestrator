...
class ImportValidator:
    ...
    def validate_file_format(file_path: str) -> Tuple[bool, Optional[str]]:
        ...
        if path.suffix.lower() not in ImportValidator.ALLOWED_EXTENSIONS:
            return False, f"Invalid file format. Allowed: {', '.join(ImportValidator.ALLOWED_EXTENSIONS)}"
        ...
        if file_size > ImportValidator.MAX_FILE_SIZE:
            return False, f"File too large. Maximum size: {ImportValidator.MAX_FILE_SIZE / 1024 / 1024}MB"
    ...
    @staticmethod
    def validate_file_content(file_path: str, entity: ExportEntity) -> Tuple[bool, List[Dict[str, Any]]]:
        """
    ...
    def _validate_csv_content(file_path: str, entity: ExportEntity) -> List[Dict[str, Any]]:
        ...
        try:
            with open(file_path, "r", encoding="utf-8") as f:
                ...
                for row in reader:
                    row_errors = ImportValidator._validate_row(row, row_num, entity, reader.fieldnames)
